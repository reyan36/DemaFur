...
| Visual analysis | OpenAI image requests using sampled frames, structured observations, frame/time validation, no identity recognition | Needs API account; accuracy against real recordings unmeasured |
